...
class VpnAgent(vpn_db.VPNPluginDb, vpn_db.VPNPluginRpcDbMixin):
    ...
    def _eval_rest_calls(self, reason, body):
        ...
        if reason == 'create':
            rpcClient.cctxt.cast(context, 'create_network_function_config',
                                 body=body)
        else:
            rpcClient.cctxt.cast(context, 'delete_network_function_config',
                                 body=body)
    ...
    def vpnservice_updated(self, context, **kwargs):
        ...
        self._eval_rest_calls(reason, body)
