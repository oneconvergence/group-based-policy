...
gbp servicechain-node-create  --service-profile vyos_fw_profile --template-file ./templates/fw_template.yml VYOS-FWNODE
gbp servicechain-spec-create --nodes "VYOS-FWNODE" fw-chainspec
