...
class F5OrchestrationDriver(odb.OrchestrationDriverBase):

    def __init__(self, config=None, supports_device_sharing=False,
                 supports_hotplug=False, max_interfaces=10):
        super(F5OrchestrationDriver, self).__init__(
            config,
            supports_device_sharing=supports_device_sharing,
            supports_hotplug=supports_hotplug,
            max_interfaces=max_interfaces)
        self.service_vendor = 'f5'
