...
class iControlDriver(LBaaSBaseDriver):
    ...
    def __init__(self, conf, icontrol_hostnames, registerOpts=True, opts_override=False):
        ...
        if opts_override:
            self.conf.set_override('f5_device_type', 'guest_admin')
            self.conf.set_override('f5_ha_type', 'standalone')
            LOG.debug('Setting f5_device_type to: %s'%self.conf.f5_device_type)
            LOG.debug('Setting f5_ha_type to: %s'%self.conf.f5_ha_type)
        self.hostnames = None
        ...
        self._init_bigip_hostnames(icontrol_hostnames)
    ...
    def _init_bigip_hostnames(self, icontrol_hostnames):
        ...
        self.hostnames = icontrol_hostnames
