...
nfp_configurator_opts = [
    ...
    oslo_config.StrOpt('rabbit_hosts',
                       default='127.0.0.1',
                       help='RabbitMq server IP address for multinode setup'),
