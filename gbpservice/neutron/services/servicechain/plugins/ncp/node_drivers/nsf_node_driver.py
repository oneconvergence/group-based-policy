...
class NSFNodeDriver(driver_base.NodeDriverBase):
    ...
    def _create_network_service(self, context):
        ...
        return self.nsf_notifier.create_network_service(
            context.plugin_context, network_service=network_service)['id']
