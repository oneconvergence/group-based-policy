...
class MakeDictionaries(object):
    ...
    def __init__(self):
        ...
        self.vpn_vpnsvc_status = [{'status': 'ERROR',
                               'updated_pending_status': True,
                               'id': '36cd27d5-8ad0-4ed7-8bbe-57c488a17835'}]
        self.ipsec_vpnsvc_status = [{'status': 'ACTIVE', 'ipsec_site_connections': {'ac3a0e54-cdf2-4ea7-ac2f-7c0225ab9af9': {'status': 'INIT', 'updated_pending_status': True}}, 'updated_pending_status': False, 'id': '36cd27d5-8ad0-4ed7-8bbe-57c488a17835'}]
    ...
    def test_create_vpn_service(self):
        ...
        with mock.patch.object(self.plugin_rpc, 'update_status') as (
            ...
            mock_update_status.assert_called_with(
                                        self.context,
                                        self.dict_objects.vpn_vpnsvc_status)
    ...
    def test_create_ipsec_site_conn(self):
        ...
        with mock.patch.object(self.plugin_rpc, 'update_status') as (
            ...
            mock_post.assert_called_with(
                            ...
                            data=json.dumps(self.dict_objects.ipsec_data),
