...
from gbpservice.neutron.tests.unit.nfp.orchestrator import dummy_dicts
...
class TestHeatDriver(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dummy_dict = dummy_dicts.DummyDictionaries()
    ...
    def mock_objects(self):
        ...
        self.heat_driver_obj.neutron_client.get_port = mock.MagicMock(
            return_value=self.dummy_dict.port_info)
        ...
        self.heat_driver_obj.neutron_client.get_subnets = mock.MagicMock(
            return_value=self.dummy_dict.subnets_info['subnets'])
        self.heat_driver_obj.neutron_client.get_subnet = mock.MagicMock(
            return_value=self.dummy_dict.subnet_info)
        self.heat_driver_obj.gbp_client.get_external_policies = mock.MagicMock(
            return_value=self.dummy_dict.external_policies[
                'external_policies'])
        ...
        self.heat_driver_obj.gbp_client.create_policy_target =\
            mock.MagicMock(return_value=self.dummy_dict.policy_target)
    ...
    def test_get_member_ips(self, list_pt_mock_obj, show_port_mock_obj):
        list_pt_mock_obj.return_value = self.dummy_dict.policy_targets
        show_port_mock_obj.return_value = self.dummy_dict.port_info
        auth_token = "81273djs138"
        expected_member_ips = ['42.0.0.13']
        member_ips = self.heat_driver_obj._get_member_ips(
            auth_token, self.dummy_dict.provider_ptg)
    ...
    def test_generate_lb_member_template(self):
        ...
        stack_template = self.dummy_dict.DEFAULT_LB_CONFIG
    ...
    def test_modify_fw_resources_name(self):
        is_template_aws_version = False
        stack_template = self.dummy_dict.DEFAULT_FW_CONFIG
        expected_fw_resources_name = 'serviceVM_infra_FW-lb_redirect'
        self.heat_driver_obj._modify_fw_resources_name(
            stack_template, self.dummy_dict.provider_ptg,
            is_template_aws_version)
    ...
    def test_get_heat_resource_key(self):
        ...
        template_resource_dict = self.dummy_dict.DEFAULT_LB_CONFIG['resources']
    ...
    def test_generate_pool_members(self, list_pt_mock_obj, show_port_mock_obj):
        ...
        auth_token = "81273djs138"
        config_param_values = {}
        expected_pool_members = self.dummy_dict.pool_members
        self.heat_driver_obj._generate_pool_members(
            auth_token,
            stack_template,
            config_param_values,
            self.dummy_dict.provider_ptg,
            is_template_aws_version)
    ...
    def test_append_firewall_rule(self):
        ...
        self.heat_driver_obj._append_firewall_rule(
            ...
            self.dummy_dict.fw_template_properties,
            consumer_id)
    ...
    def test_delete_config(self, mock_obj, heat_get_mock_obj,
        ...
        service_details = {}
        service_details['policy_target_group'] = self.dummy_dict.provider_ptg
        self.heat_driver_obj.delete_config(service_details, stack_id)
    ...
    def test_is_config_complete(self, mock_obj, heat_get_mock_obj):
        ...
        status = self.heat_driver_obj.is_config_complete(
                stack_id, tenant_id, self.dummy_dict.network_function_details)
    ...
    @mock.patch.object(heat_client.HeatClient, "delete")
    @mock.patch.object(identity_client, "Client")
    def test_wait_for_stack_operation_complete(
            self, mock_obj,
            heat_delete_mock_obj, heat_get_mock_obj):
        heat_get_mock_obj.return_value = MockStackObject(
            'DELETE_COMPLETE')
        self.heat_driver_obj._assign_admin_user_to_project = mock.Mock(
            return_value=None)
        ...
        instance.auth_token = True
        resource_owner_tenant_id = '8ae6701128994ab281dde6b92207bb19'
        heatclient = self.heat_driver_obj._get_heat_client(
            resource_owner_tenant_id,
            tenant_id=None)
        stack_id = '70754fdd-0325-4856-8a39-f171b65617d6'
        action = 'delete'
        self.heat_driver_obj._wait_for_stack_operation_complete(
            heatclient, stack_id, action)

    def test_get_site_conn_keys(self):
        is_template_aws_version = False
        resource_name = 'OS::Neutron::IPsecSiteConnection'
        template_resource_dict =\
            self.dummy_dict.DEFAULT_VPN_CONFIG['resources']
    ...
    def test_get_management_gw_ip(self, list_ptg_mock_obj,
        ...
        list_ptg_mock_obj.return_value = self.dummy_dict.policy_target_groups
        show_subnet_mock_obj.return_value = self.dummy_dict.subnet_info
    ...
    def test_get_consumers_for_chain(self, list_policy_rule_sets_mock_obj,
        ...
        list_policy_rule_sets_mock_obj.return_value =\
            self.dummy_dict.policy_rule_sets
        list_policy_rules_mock_obj.return_value = self.dummy_dict.policy_rules
        list_policy_actions_mock_obj.return_value =\
            self.dummy_dict.policy_actions
        auth_token = 'jkijqe18381'
    ...
    def test_update_firewall_template(self):
        ...
        auth_token = 'adakjiq'
        self.heat_driver_obj._update_firewall_template(
            auth_token,
            self.dummy_dict.provider_ptg, stack_template)

    @mock.patch.object(gbp_client.Client, "list_l3_policies")
    def test_get_rvpn_l3_policy(self, mock_obj):
        mock_obj.return_value = self.dummy_dict.l3_policies
        ...
        rvpn_l3_policy = self.heat_driver_obj._get_rvpn_l3_policy(
            auth_token,
            self.dummy_dict.provider_ptg, node_update)
    ...
    def test_create_policy_target_for_vip(self, vip, pools, subnets, pt):
        ...
        subnets.return_value = self.dummy_dict.subnets_info
        pools.return_value = {
            'pools': [{
                'vip_id': '1234'
            }]
        ...
        provider = self.dummy_dict.provider_ptg
    ...
    def test_update_node_config(self):
        ...
        tenant_id = '8ae6701128994ab281dde6b92207bb19'
        provider = self.dummy_dict.provider_ptg
        provider_port = self.dummy_dict.port_info['port']
        mgmt_ip = '11.3.4.5'
        stack_template, stack_params =\
            self.heat_driver_obj._update_node_config(
                auth_token, tenant_id,
                self.dummy_dict.service_profile,
                self.dummy_dict.fw_service_chain_node,
                self.dummy_dict.service_chain_instance,
                provider, self.dummy_dict.consumer_port,
    ...
    def test_update(
        ...
        service_details = {}
        service_details['service_profile'] = self.dummy_dict.service_profile
        service_details['servicechain_node'] =\
            self.dummy_dict.fw_service_chain_node
        service_details['servicechain_instance'] =\
            self.dummy_dict.service_chain_instance
        service_details['policy_target_group'] = self.dummy_dict.provider_ptg
        service_details['provider_ptg'] = self.dummy_dict.provider_ptg
        service_details['consumer_ptg'] = self.dummy_dict.consumer_ptg
        service_details['consumer_port'] = self.dummy_dict.consumer_port
        service_details['provider_port'] = self.dummy_dict.port_info['port']
    ...
    def test_handle_consumer_ptg_operations(
        ...
        policy_target_group = self.dummy_dict.provider_ptg
        stack_id = self.heat_driver_obj.handle_consumer_ptg_operations(
            self.dummy_dict.network_function_details,
    ...
    def test_handle_policy_target_operations(
        ...
        service_details = {}
        service_details['service_profile'] = self.dummy_dict.lb_service_profile
        service_details['servicechain_node'] =\
            self.dummy_dict.lb_service_chain_node
        service_details['servicechain_instance'] =\
            self.dummy_dict.service_chain_instance
        service_details['policy_target_group'] = self.dummy_dict.provider_ptg
        service_details['provider_ptg'] = self.dummy_dict.provider_ptg
