        ...
        self.routers = [
            {
             ...
             "external_gateway_info": {
                "network_id": "a413e04d-1431-4b21-8327-d4de25fa604b",
                "external_fixed_ips": [
                    {
                        "subnet_id": "fcc74b65-dafe-4b74-91fa-028dec8467a8",
        ...
        self.vpnservices = [
            {
             ...
             "description": (
                "fip=1.203.1.108;tunnel_local_cidr=11.0.0.0/24;"
                "user_access_ip=1.203.2.101;fixed_ip=192.168.0.3;standby_fip=;"
                "service_vendor=vyos;stitching_cidr=192.168.0.0/28;"
...

            {
             ...
             "description": (
                "fip=1.203.1.109;tunnel_local_cidr=12.0.0.0/24;"
                "user_access_ip=1.203.2.102;fixed_ip=192.168.0.4;standby_fip=;"
                "service_vendor=vyos;stitching_cidr=192.168.0.0/28;"
                "stitching_gateway=192.168.1.1;mgmt_gw_ip=121.0.0.1")
                }
