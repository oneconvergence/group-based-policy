...
import threading
import signal
#from gbpservice.neutron.nsf.proxy import proxy
import proxy
...
class ProxyStart():
    ...
    def __init__(self):
        ...
        #self.conf = proxy.Configuration(os.path.abspath("gbpservice/neutron/nsf/proxy/proxy.ini"))
        self.conf = proxy.Configuration('/home/rahul/oc_git/group-based-policy/gbpservice/neutron/nsf/proxy/proxy.ini')
