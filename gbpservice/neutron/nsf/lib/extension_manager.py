...
cfg.CONF.register_opt(cfg.StrOpt('drivers'), 'oneconvergence_lifecycle_drivers')
...
class ExtensionManager(stevedore.named.NamedExtensionManager):
    ...
    def __init__(self, sc_context, conf):
        super(ExtensionManager, self).__init__(
            'gbpservice.neutron.nsf.lifecycle_manager.drivers',
            cfg.CONF.oneconvergence_lifecycle_drivers.drivers,
            invoke_on_load=True,
